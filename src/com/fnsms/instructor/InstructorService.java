...
//				printAtendancePunchOut();
	...
	/**
	 * 캘린더 객체를 입력받아 형식을 갖춘 문자열을 반환합니다.
	 * @param cal 포맷을 바꿀 캘린더 변수
	 * @return yyyy-mm-dd hh:mi:ss 형식의 문자열
	 */
...
//		if ()
	...
	//직원의 이번주 근퇴 리스트 반환
	/**
	 * 직원이 이번주에 근무했었던 근퇴리스트를 반환합니다.
	 * @param emp 직원
	 * @return 이번주에 근무했었던 Attendance 객체타입의 ArrayList
	 */
...
//    }//findInstructor
	 ...
	 * 특정월의 근무시간을 구합니다.
	 * @param empNo 사원번호
	 * @param yyyyMM 특정월을 상징하는 형식을 갖춘 문자열
	 * @return 특정월의 근무시간
	 */
    ...
    /**
     * 사원이 특정월에 수행했던 수업 건수 구합니다.
     * @param empNo 사원번호
     * @param yyyyMM yyyyMM 특정월을 상징하는 형식을 갖춘 문자열
     * @return 특정월의 수업건수
     */
...
//              System.out.println("날짜별 예약 조회를 선택하셨습니다.");
    ...
    /**
     * 강사의 가장 빠른 수업 예정일을 구합니다.
     * @param ins
     * @return 강사의 가장 빠른 수업 예정일
     */
 ...
 // 기간이 유효한 이용권 등록 가져오기(현재일이 시작일과 종료일 기간이 아니면 해당되지 않음)
    /**
     * 기간이 유효한 이용권 등록리스트를 구합니다.(현재일이 시작일과 종료일 기간이 아니면 해당되지 않음)
     * @param instructor 강사
     * @return 기간이 유효한 이용권 등록 ArrayList
     */
